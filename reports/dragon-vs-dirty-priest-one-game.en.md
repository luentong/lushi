...
30. Player 1: End turn
   Global state after turn:
   - P1: HP 28/30, Armor 0, Mana 0/5, Hand 4 [Erupting Volcano, Afflicted Devastator, Erupting Volcano, Chillmaw], Deck 23, Board [Prescient Slitherdrake (5/8, damage 0), Darkrider (1/1, damage 0)], Weapon [none], Locations [none]
...
35. Player 2: End turn
   Global state after turn:
   - P1: HP 28/30, Armor 0, Mana 6/6, Hand 5 [Erupting Volcano, Afflicted Devastator, Erupting Volcano, Chillmaw, Royal Librarian], Deck 22, Board [Prescient Slitherdrake (5/4, damage 4)], Weapon [none], Locations [none]
...
40. Player 1: End turn
   Global state after turn:
   - P1: HP 28/30, Armor 2, Mana 0/6, Hand 4 [Erupting Volcano, Erupting Volcano, Chillmaw, Royal Librarian], Deck 22, Board [Afflicted Devastator (6/6, damage 0)], Weapon [none], Locations [none]
...
42. Player 2: End turn
   Global state after turn:
   - P1: HP 28/30, Armor 2, Mana 7/7, Hand 5 [Erupting Volcano, Erupting Volcano, Chillmaw, Royal Librarian, Sanguine Depths], Deck 21, Board [Afflicted Devastator (6/6, damage 0)], Weapon [none], Locations [none]
...
45. Player 1: End turn
   Global state after turn:
   - P1: HP 28/30, Armor 2, Mana 0/7, Hand 4 [Erupting Volcano, Erupting Volcano, Royal Librarian, Sanguine Depths], Deck 21, Board [Chillmaw (9/6, damage 0)], Weapon [none], Locations [none]
   - P2: HP 30/40, Armor 0, Mana 7/7, Hand 3 [Windpeak Wyrm, Hook n' Heave, Darkrider], Deck 30, Board [Bonechill Stegodon (6/3, damage 0)], Weapon [none], Locations [Sanguine Depths (durability 1, cooldown 0)]
...
53. Player 2: End turn
   ...
   - P2: HP 30/40, Armor 0, Mana 0/7, Hand 3 [Windpeak Wyrm, Runaway Blackwing, The Coin], Deck 30, Board [Cannoneer (1/1, damage 0), Cannoneer (1/1, damage 0), Time Skipper (5/3, damage 1), Darkrider (1/1, damage 0)], Weapon [none], Locations [none]
...
57. Player 1: End turn
   Global state after turn:
   - P1: HP 24/30, Armor 0, Mana 0/8, Hand 2 [Erupting Volcano, Sanguine Depths], Deck 20, Board [Royal Librarian (4/4, damage 0), Darkrider (1/1, damage 0)], Weapon [none], Locations [Erupting Volcano (durability 3, cooldown 2)]
   - P2: HP 30/40, Armor 0, Mana 8/8, Hand 4 [Windpeak Wyrm, Runaway Blackwing, The Coin, Soothsayer], Deck 29, Board [Cannoneer (1/1, damage 0), Cannoneer (1/1, damage 0), Time Skipper (3/3, damage 1), Darkrider (1/1, damage 0)], Weapon [none], Locations [none]
...
67. Player 2: End turn
   ...
   - P2: HP 30/40, Armor 5, Mana 0/8, Hand 2 [Runaway Blackwing, Soothsayer], Deck 27, Board [Time Skipper (3/2, damage 2), Warptooth (3/3, damage 0), Windpeak Wyrm (6/6, damage 0)], Weapon [none], Locations [none]
...
74. Player 1: End turn
   Global state after turn:
   - P1: HP 16/30, Armor 0, Mana 1/9, Hand 0 [empty], Deck 19, Board [Mother Duck (2/3, damage 0)], Weapon [none], Locations [Erupting Volcano (durability 3, cooldown 1), Erupting Volcano (durability 3, cooldown 2), Sanguine Depths (durability 3, cooldown 2)]
   - P2: HP 30/40, Armor 5, Mana 9/9, Hand 3 [Runaway Blackwing, Soothsayer, Karazhan the Sanctum], Deck 26, Board [Time Skipper (3/2, damage 2), Warptooth (3/3, damage 0), Windpeak Wyrm (6/3, damage 3)], Weapon [none], Locations [none]
...
82. Player 2: End turn
   ...
   - P2: HP 30/40, Armor 5, Mana 0/9, Hand 2 [Runaway Blackwing, Karazhan the Sanctum], Deck 26, Board [Time Skipper (3/2, damage 2), Warptooth (3/3, damage 0), Windpeak Wyrm (6/1, damage 5), Soothsayer (6/6, damage 0), Sinful Steed (2/3, damage 0)], Weapon [none], Locations [none]
...
88. Player 1: End turn
   Global state after turn:
   - P1: HP 10/30, Armor 2, Mana 1/10, Hand 0 [empty], Deck 18, Board [Cannoneer (1/1, damage 0), Cannoneer (1/1, damage 0), Captain Crowley (4/5, damage 0), Cannoneer (1/1, damage 0)], Weapon [none], Locations [Erupting Volcano (durability 2, cooldown 2), Erupting Volcano (durability 3, cooldown 1), Sanguine Depths (durability 3, cooldown 1)]
   - P2: HP 30/40, Armor 3, Mana 10/10, Hand 3 [Runaway Blackwing, Karazhan the Sanctum, Lunarwing Messenger], Deck 25, Board [Time Skipper (3/1, damage 3), Warptooth (3/2, damage 1), Soothsayer (6/2, damage 4), Sinful Steed (2/3, damage 0)], Weapon [none], Locations [none]
...
94. Player 2: End turn
   ...
   - P2: HP 36/40, Armor 3, Mana 0/10, Hand 2 [Karazhan the Sanctum, Lunarwing Messenger], Deck 25, Board [Warptooth (3/1, damage 2), Sinful Steed (2/2, damage 1), Bonechill Stegodon (6/3, damage 0), Runaway Blackwing (13/10, damage 0)], Weapon [none], Locations [none]
...
101. Player 1: End turn
   Global state after turn:
   - P1: HP 10/30, Armor 4, Mana 2/10, Hand 1 [The Coin], Deck 17, Board [Cannoneer (1/1, damage 0), Cannoneer (1/1, damage 0), Time Skipper (3/4, damage 0)], Weapon [none], Locations [Erupting Volcano (durability 2, cooldown 1), Erupting Volcano (durability 2, cooldown 2), Sanguine Depths (durability 2, cooldown 2)]
   - P2: HP 36/40, Armor 1, Mana 10/10, Hand 3 [Karazhan the Sanctum, Lunarwing Messenger, Medivh the Hallowed], Deck 24, Board [Bonechill Stegodon (6/2, damage 1), Runaway Blackwing (13/10, damage 0), Sinful Steed (2/3, damage 0)], Weapon [none], Locations [none]
...
106. Player 2: End turn
   ...
   - P2: HP 40/40, Armor 1, Mana 0/10, Hand 2 [Karazhan the Sanctum, Lunarwing Messenger], Deck 24, Board [Medivh the Hallowed (7/7, damage 0)], Weapon [none], Locations [none]
...
112. Player 1: End turn
   Global state after turn:
   - P1: HP 10/30, Armor 6, Mana 7/10, Hand 0 [empty], Deck 16, Board [Cannonmaster (3/1, damage 0), Cannoneer (1/1, damage 0)], Weapon [none], Locations [Erupting Volcano (durability 1, cooldown 2), Erupting Volcano (durability 2, cooldown 1), Sanguine Depths (durability 2, cooldown 1)]
   - P2: HP 39/40, Armor 0, Mana 10/10, Hand 3 [Karazhan the Sanctum, Lunarwing Messenger, Bitterbloom Knight], Deck 23, Board [Medivh the Hallowed (7/5, damage 2)], Weapon [none], Locations [none]
113. Player 2: Minion attack [Medivh the Hallowed] -> [Cannonmaster]
114. Player 2: Play [Karazhan the Sanctum]
115. Player 2: End turn
   Global state after turn:
   - P1: HP 10/30, Armor 6, Mana 10/10, Hand 1 [Windpeak Wyrm], Deck 15, Board [Cannoneer (1/1, damage 0)], Weapon [none], Locations [Erupting Volcano (durability 1, cooldown 1), Erupting Volcano (durability 2, cooldown 0), Sanguine Depths (durability 2, cooldown 0)]
   - P2: HP 39/40, Armor 0, Mana 0/10, Hand 2 [Lunarwing Messenger, Bitterbloom Knight], Deck 23, Board [Medivh the Hallowed (7/2, damage 5)], Weapon [none], Locations [Karazhan the Sanctum (durability 2, cooldown 2)]
...
121. Player 1: End turn
   Global state after turn:
   - P1: HP 10/30, Armor 13, Mana 0/10, Hand 0 [empty], Deck 15, Board [Windpeak Wyrm (8/5, damage 1)], Weapon [none], Locations [Erupting Volcano (durability 1, cooldown 1), Erupting Volcano (durability 1, cooldown 2), Sanguine Depths (durability 1, cooldown 2)]
...
125. Player 2: End turn
   Global state after turn:
   - P1: HP 10/30, Armor 13, Mana 10/10, Hand 1 [Cannonmaster], Deck 14, Board [Windpeak Wyrm (8/5, damage 1)], Weapon [none], Locations [Erupting Volcano (durability 1, cooldown 0), Erupting Volcano (durability 1, cooldown 1), Sanguine Depths (durability 1, cooldown 1)]
   - P2: HP 36/40, Armor 0, Mana 0/10, Hand 9 [Bitterbloom Knight, Prescient Slitherdrake, Chainbreaker Hogger, Atiesh the Greatstaff, Moonwell, Erupting Volcano, Brood Keeper, Royal Librarian, Cannoneer], Deck 14, Board [Azalina Soulsever (7/7, damage 0), Lunarwing Messenger (3/2, damage 0), Cannonmaster (3/1, damage 0)], Weapon [none], Locations [Karazhan the Sanctum (durability 2, cooldown 1)]
...
131. Player 1: End turn
   Global state after turn:
   - P1: HP 10/30, Armor 15, Mana 6/10, Hand 0 [empty], Deck 14, Board [Cannonmaster (3/1, damage 0), Cannoneer (1/1, damage 0)], Weapon [none], Locations [Erupting Volcano (durability 1, cooldown 1), Sanguine Depths (durability 1, cooldown 1)]
   - P2: HP 34/40, Armor 0, Mana 10/10, Hand 10 [Bitterbloom Knight, Prescient Slitherdrake, Chainbreaker Hogger, Atiesh the Greatstaff, Moonwell, Erupting Volcano, Brood Keeper, Royal Librarian, Cannoneer, Windpeak Wyrm], Deck 13, Board [Cannonmaster (3/1, damage 0)], Weapon [none], Locations [Karazhan the Sanctum (durability 2, cooldown 0)]
...
137. Player 2: End turn
   ...
   - P2: HP 34/40, Armor 5, Mana 0/10, Hand 8 [Bitterbloom Knight, Prescient Slitherdrake, Chainbreaker Hogger, Atiesh the Greatstaff, Moonwell, Erupting Volcano, Royal Librarian, Cannoneer], Deck 13, Board [Windpeak Wyrm (6/6, damage 0), Brood Keeper (2/3, damage 0), Bronze Keeper (3/7, damage 0), Windpeak Wyrm (6/6, damage 0), Sandscale Dragon (6/6, damage 0)], Weapon [Brood Keeper's Sword], Locations [Karazhan the Sanctum (durability 1, cooldown 2)]
...
143. Player 1: End turn
   ...
   - P2: HP 34/40, Armor 4, Mana 10/10, Hand 9 [Bitterbloom Knight, Prescient Slitherdrake, Chainbreaker Hogger, Atiesh the Greatstaff, Moonwell, Erupting Volcano, Royal Librarian, Cannoneer, Moonwell], Deck 12, Board [Windpeak Wyrm (6/4, damage 2), Bronze Keeper (3/5, damage 2), Windpeak Wyrm (6/4, damage 2), Sandscale Dragon (8/3, damage 3)], Weapon [Brood Keeper's Sword], Locations [Karazhan the Sanctum (durability 1, cooldown 1)]

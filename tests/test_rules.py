...
class RuleRegistryTests(unittest.TestCase):
    def test_first_migration_has_machine_readable_provenance(self):
        ...
        # The registry is append-only as card migrations land; retain the
        # original tranche as a floor instead of freezing its row count.
        self.assertGreaterEqual(len(rows), 185)
